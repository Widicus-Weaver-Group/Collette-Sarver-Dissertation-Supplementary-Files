...
2) Chapter 5, containing all data relevant to the observational astronomy research for the star-forming region IRAS 4B and 4Bâ€™. This includes spectral fits, the last used GOBASIC file structure, parameter map inputs and outputs, python scripts, baseline corrected continuum subtracted fits files, and images used in the published paper.

3) Chapter 6, containing all data relevant to the computational chemistry research involving `Gaussian 16` input and output files, dat files used in the Mulliken charge population figures, and images used in the published paper.
