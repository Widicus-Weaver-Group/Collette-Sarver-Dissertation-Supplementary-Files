...
2) Chapter 5, containing all data relevant to the observational astronomy research for the star-forming region IRAS 4B and 4B'. This includes spectral fits, the last used GOBASIC file structure, parameter map inputs and outputs, python scripts, baseline corrected continuum subtracted fits files, and images used in the published paper.
